...
const bot = {
    TOKEN:'5915215954:AAFoytad7nKJbgqzw9raPGqwU4W-Qtm8GDU',
    chatID:'-884436339'
}
    ...
    if(message.value && number.value && message.value.trim()) {
        ...
        fetch(TELEGRAM_API)
            .then(response => {
                if (response.ok) {
                    thankYou.innerHTML = `
        <img src = 'galochka.png' style="height: 100px; display: block; position: relative; margin: auto; top: 0;bottom: 0;left: 0;right: 0;">
        ...
        clearInput() 
                  ...
                  thankYou.innerHTML = `
                  <img src = 'krestik.jpg' style="height: 90px; display: block; position: absolute; margin: auto; top: 0;bottom: 0;left: 0;right: 0;">
